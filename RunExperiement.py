...
spaceexp = {
            ...
            'nround': hp.uniformint('nround', 100,300),
...
EXPERIEMNTNAME = "FullFeatureTest_v1"
...
MODEL = LightGBMModel
MAXEVAL = 400
CVParams = {'num_folds':10, 'shuffle': True, 'random_state':17}



exp = OAExperiment(DATAPATH, MODEL, TrainTestSplitFun ,SplitDate, spaceexp, MAXEVAL, CVParams, "" ,DESCRIPTION ,experimentname = EXPERIEMNTNAME)
